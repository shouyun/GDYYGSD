 ...
 * @since     [产品/模块版本]
 */
public interface ITermInfoService extends IBaseService<TermInfo> {
     ...
     * @see  [类、类#方法、类#成员]
     */
    void newFlie(String file, List<TermInfo> list)
        throws IOException;
     ...
     * @see  [类、类#方法、类#成员]
     */
    void newVsFlie(String file, List<TermInfo> list)
        throws IOException;
